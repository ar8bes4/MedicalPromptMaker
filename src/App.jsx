...
function App() {
  const [system, setSystem] = useState('internal');
  const [dept, setDept] = useState('m_endocrinology');
...
- 重要な箇所は **太字** で強調する。
    ...
    <role>
        あなたは、地域医療に長年貢献し、患者様から「説明が非常にわかりやすい」と絶大な信頼を寄せられている熟練の${deptLabel}医です。
        専門用語を避けつつ、医学的な正確さを保ちながら、安心感を与える丁寧な言葉遣いで説明を行うプロフェッショナルです。
    ...
    <div className="container">
      ...
      <div className="form-grid">
        ...
        <div className="form-group step-group">
          <label className="step-label">STEP 2: 診療科を選択</label>
